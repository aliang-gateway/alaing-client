...
func registerRoutesWithMux(h *routes.Handlers) {
	...
	mux.HandleFunc("/api/proxy/registry/register", h.ProxyRegistry.HandleProxyRegistryRegister)
	mux.HandleFunc("/api/proxy/registry/unregister", h.ProxyRegistry.HandleProxyRegistryUnregister)
	mux.HandleFunc("/api/proxy/registry/set-default", h.ProxyRegistry.HandleProxyRegistrySetDefault)
	mux.HandleFunc("/api/proxy/registry/set-door", h.ProxyRegistry.HandleProxyRegistrySetDoor)
	mux.HandleFunc("/api/proxy/registry/switch", h.ProxyRegistry.HandleProxyRegistrySwitch)

	// Config routes (/api/config/*)
	mux.HandleFunc("/api/config/get", h.Config.HandleConfigGet)
	mux.HandleFunc("/api/config/list", h.Config.HandleConfigList)
