...
// TestVLESSRealityTLS 测试使用标准 TLS 的 REALITY 实现
func TestVLESSRealityTLS(t *testing.T) {
	t.Logf("=== 测试使用标准 TLS 的 REALITY 实现 ===")
...
func testRealityTLS(t *testing.T, vless *proxy.VLESS, name string, ip [4]byte, host string) {
	...
	// 发送 HTTP 请求
	req := fmt.Sprintf("GET / HTTP/1.1\r\nHost: %s\r\nUser-Agent: VLESS-REALITY-TLS-Test\r\nConnection: close\r\n\r\n", host)
