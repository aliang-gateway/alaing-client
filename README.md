...
- **Intelligent Routing**: Multi-priority rule evaluation (Bypass → Cache → Nacos → GeoIP → Direct)
...
- **Nacos SDK** (nacos-group/nacos-sdk-go) - Service discovery and configuration
